...
function addParagraph(node, text, length, disableInlineStyles = false) {
...
function parseRangesToHTMLNodes(text, ranges, isMultiline = true, markdownStyle = {}, disableInlineStyles = false, currentInput = null, inlineImagesProps = {}) {
  ...
  const markdownRanges = (0, _rangeUtils.ungroupRanges)(sortedRanges);
...
function updateInputStructure(parserFunction, target, text, cursorPositionIndex, isMultiline = true, markdownStyle = {}, alwaysMoveCursorToTheEnd = false, shouldForceDOMUpdate = false, shouldScrollIntoView = false, inlineImagesProps = {}) {
