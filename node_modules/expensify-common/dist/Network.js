...
function Network(endpoint) {
    ...
    return {
         ...
         */
        get(url) {
            return jquery_1.default.get(url);
        },
        /**
        ...
        post(parameters) {
            ...
            return jquery_1.default.ajax(settings);
        },
        /**
        ...
        keepalive(parameters) {
            ...
            const promise = new jquery_1.default.Deferred();
            fetch(url, settings)
                .then(() => {
        ...
        registerNetworkFailureHandler(callback) {
            (0, jquery_1.default)(document).ajaxError((event, jqxhr) => {
