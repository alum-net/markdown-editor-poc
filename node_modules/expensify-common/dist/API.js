...
function API(network, args) {
    ...
    function performPOSTRequest(command, parameters, returnedPropertyName, keepalive, checkCodeRevision) {
        ...
        const codeRevisionPromise = checkCodeRevision ? isRunningLatestVersionOfCode : () => new simply_deferred_1.Deferred().resolve();
        ...
        const networkRequestPromise = new simply_deferred_1.Deferred();
        // This is the final APIDeferred which gets returned from the API lib.
        const finalApiDeferred = new APIDeferred_1.default(networkRequestPromise, returnedPropertyName);
    ...
    return {
        ...
        resendValidateCode(parameters = {}) {
            ...
            return performPOSTRequest(commandName, Object.assign(Object.assign({}, parameters), { api_setCookie: false }));
        },
        /**
